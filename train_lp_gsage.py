'''
From https://github.com/dmlc/dgl/blob/master/examples/pytorch/graphsage/advanced/train_sampling_unsupervised.py
'''
import os
import dgl
import numpy as np
...
from sage_model import GraphSAGE, compute_acc_unsupervised as compute_acc
...
def run(proc_id, n_gpus, args, devices, data):
    ...
    model = GraphSAGE(data_info={}, embed_size=256, hidden_size=128, num_layers=1, activation="relu", dropout=0.5, aggregator_type="mean")
...
def main(args):
    ...
    g = dgl.load_graphs(args.dataset)
    ...
    # Pack data
    data = train_nid, val_nid, test_nid, g, nfeat, labels
...
if __name__ == '__main__':
    ...
    argparser.add_argument('--dataset', type=str, default='./graphs/industrial_and_scientific_5_core.dgl')
